#!/bin/bash
#SBATCH --job-name=laplacian_integral_con_graphs_1to11
...
CAT="con"
DST="/home/pusheen/scratch/small-laplacian-integral-graphs/data/laplacian_integral_con_graphs_1to11.txt"
