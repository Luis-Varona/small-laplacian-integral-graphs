#!/bin/bash
#SBATCH --job-name=laplacian_integral_con_reg_graphs_1to14
...
CAT="con_reg"
DST="/home/pusheen/scratch/small-laplacian-integral-graphs/data/laplacian_integral_con_reg_graphs_1to14.txt"
